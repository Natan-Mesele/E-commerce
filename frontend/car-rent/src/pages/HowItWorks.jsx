...
function HowItWorks() {
  return (
    <div className="container mx-auto py-12 px-4">
      <h1 className="text-4xl font-bold text-center text-gray-500 mb-8">How It Works</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
          <FaSearch className="text-4xl text-custom-primary mb-4" /> {/* Icon for step 1 */}
        ...
        {/* Step 2 */}
        <div className="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
          <FaHandPointRight className="text-4xl text-custom-primary mb-4" /> {/* Icon for step 2 */}
        ...
        {/* Step 3 */}
        <div className="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
          <FaCalendarCheck className="text-4xl text-custom-primary mb-4" /> {/* Icon for step 3 */}
